...
## Workflow Priority:
1. **For simple requests** - Try the direct query first with minimal required params
2. **If that fails** - Then use lookup tools to understand the structure
3. **Always complete the user's request** - Don't stop at just discovery
