/**
 * UserProfileClient - Dashboard2 user profile dropdown
 * Based on Dashboard1's UserProfileClient with Dashboard2 styling
 */
...
export function UserProfileClient({ user }: UserProfileClientProps) {
  ...
  const handleSignOut = async () => {
    // Use dashboard2 signout endpoint
    window.location.href = "/dashboard2/signin";
  };
          ...
          >
            <DropdownMenuLabel className="p-0 font-normal">
              <div
                ...
                onClick={() =>
                  (window.location.href = `/dashboard2/users/${user.id}`)
                }
              >
