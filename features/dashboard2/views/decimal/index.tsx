/**
 * Decimal field view - Placeholder based on Keystone structure
 */
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="p-4 border rounded bg-gray-50">
        <div className="text-sm text-gray-600">DECIMAL FIELD PLACEHOLDER</div>
...
export function Cell({ item, field }: any) {
  ...
  return (
    <span className="text-sm font-mono">
      {value !== null && value !== undefined ? value : <span className="text-gray-400">DECIMAL PLACEHOLDER</span>}
    </span>
  )
}
...
export function CardValue({ item, field }: any) {
  return (
    <div>
      ...
      <div className="text-sm text-gray-600">DECIMAL CARD PLACEHOLDER</div>
    </div>
  )
}
...
export const controller = (config: any) => ({
  ...
  defaultValue: "0.00",
  deserialize: (item: any) => item[config.path] || "0.00",
